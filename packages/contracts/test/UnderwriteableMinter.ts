...
describe('UnderwriteableMinter', async () => {
  ...
  before(async () => {
    ...
    minter = UnderwriteableMinter__factory.connect('0xD7bb140b53EB814aa10f051B76B0e5b2458fBcAd', signers[0])
  })
  ...
  it('mints', async () => {
    await minter.temporaryMint(
      ...
      'BTC',
      '9186',
      Buffer.from('0d589198b9e0cd1a5a414a487ac0ad9143451b2bb56f091a85fe8f3119652b37', 'hex'),
      Buffer.from('6953730e419852b8e9f698f285e9f0f58f2f04cbd7596b12de6bd4c8bdf12def32e493de7ed8f4149d35369320121074eb77360a6220e398e4af478711d7ec0d1b', 'hex')
    )
  })
})